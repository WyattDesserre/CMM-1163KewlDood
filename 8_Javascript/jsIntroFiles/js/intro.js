...
console.log("Do you see it? "+something)
...
document.getElementById('column1').innerHTML="<h3>Holy Shit I changed the page! How the actual FUCK did that happen?!?</h3>"
document.getElementById('column1').innerHTML+="<p>What?! I can do more shit! waow<p>"
document.getElementById('column1').innerHTML+="<p>im tired<p>"
document.getElementById('column1').innerHTML+="<img src='images/code.jpg' class='img-fluid' alt='code-man to the rescue'>"
...
document.getElementById('column2').style.backgroundColor="#C51515B9"
...
if(weapon=="squid"){
    console.log("Squid Yoinked");
}else if(weapon=="Unmaker"){
    console.log("Fuck em up");
}else{
    console.log("Stop hacking plz");
};
...
document.getElementById('column69').innerHTML+="<p>Opponent's Integrity is currently "+health+"</p>";
...
document.getElementById('column69').innerHTML+="<p>Your "+weapon+" is currently dealing "+damage+" damage</p>"


//Now let's say the user has hit the opponent with their weapon
//We need to MINUS the 'damage' from the opponents 'health'
health = health - damage;
document.getElementById('column69').innerHTML+="<p>When you hit them with your "+weapon+", their Integrity will be "+health+"<p>";
...
health = health - damage;
document.getElementById('column69').innerHTML+="<p>When you hit them once more with your "+weapon+", their Integrity will be "+health+"<p>"
